...
#ifndef GRPC_CB_CORE_SERVER_REPLIER_IMPL_H
#define GRPC_CB_CORE_SERVER_REPLIER_IMPL_H
...
#include "cqtag/server_replier_cqtag.h"  // for ServerReplierCqTag
...
#endif  // GRPC_CB_CORE_SERVER_REPLIER_IMPL_H
